...
/*1.	Функция, преобразующая значение ФИО в фамилию с инициалами (например, "Иванов Иван Сергеевич" в "Иванов И.С.").
...
/*2.	Функция, выдающая полное название учетной степени по параметрам "Тип" и "Раздел науки".
 Например, для типа "докторская" и раздела "Технические науки" функция должна вернуть "доктор технических наук".*/
...
/*3.	Функция, выдающая возраст по двум датам: дате рождения и дате, на которую интересует возраст. 
Если вторая дата не указана, то возраст на текущую дату. Вызывать функцию для двух полей: дата 
рождения автора и дата защиты диссертации.*/
...
select  get_age('2000-1-1', '2020-2-2')
